...
export const PortalButton = ({ children, to, color = null }) => (		
  <PortalButtonContainer className="PortalButton" to={to} color={color}>
    {children}
...
const PortalButtonContainer = styled(Link)`
...
const SubmitContainer = PortalButtonContainer.withComponent("input")